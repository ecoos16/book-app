...
export default function ReadList() {
  ...
  /**
   * DÜZELTME:
   * Bu ekran "Okudum" listesi olduğu için status = "read" olmalı.
   */
    ...
    >
      ...
      <View style={{ gap: 4 }}>
        ...
        <Text style={{ color: COLORS.muted, lineHeight: 21 }}>
          Bitirdiğin, puanladığın veya not aldığın kitaplar burada görünür.
        </Text>
      </View>

      {/* Yeni kitap ekle */}
      <SoftButton
        label="Okudum listesine kitap ekle"
        icon="add-outline"
        onPress={() =>
          router.push({
            pathname: "/add-book",
      ...
      {books.length === 0 ? (
        <EmptyState
          ...
          description="Bitirdiğin kitapları bu listeye ekleyebilir, puan ve notlarını kaydedebilirsin."
        />
      ) : (
